...
console.log("Connecting JOEL BOT ⏳️...");
...
console.log('joel Bot connected to whatsapp ✅')

let up = `joel md onnected successful ✅\n\nPREFIX: ${prefix}`;
...
const pushname = mek.pushName || 'joel'
